-- AI chatbot without pgvector (dev / Windows): embeddings stored as JSONB array of numbers.
-- Use when CREATE EXTENSION vector fails. Application detects column type automatically.

-- Legacy peer-to-peer chat table — free the name `chat_messages` for AI chat
DO $$
BEGIN
  IF EXISTS (
