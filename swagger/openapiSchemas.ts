    ...
    properties: {
      ...
      admissionRequirements: {
        ...
        properties: {
          ...
          intake: { type: 'string', nullable: true, example: 'September, January' },
          applicationFee: { type: 'string', nullable: true, example: 'GBP 60' },
          scholarship: { type: 'string', nullable: true },
          courseUrl: { type: 'string', nullable: true },
        },
      },
    },
  },
